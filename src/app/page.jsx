          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <div className="flex gap-4 text-sm">
                ...
                <a href="https://linkedin.com/in/timothymhowe" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-neutral-900 transition-colors">LinkedIn</a>
              </div>
            </div>
          </div>
        </section>
